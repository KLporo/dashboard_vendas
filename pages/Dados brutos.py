...
with st.sidebar.expander('Frete do produto'):
    frete = st.slider('Selecione o frete', 0, 300, (0,300))
...
with st.sidebar.expander('Local da Compra'):
    locais = st.multiselect('Selecione os locais', dados['Local da compra'].unique(), dados['Local da compra'].unique())
with st.sidebar.expander('Avaliação da compra'):
    avaliacao = st.slider('Selecione a avaliação', 0, 5, (0,5))
with st.sidebar.expander('Tipo de pagamento'):
    tipos_pagamento = st.multiselect('Selecione os tipos de pagamento', dados['Tipo de pagamento'].unique(), dados['Tipo de pagamento'].unique())
